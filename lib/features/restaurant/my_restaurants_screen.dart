...
class _MyRestaurantsScreenState extends State<MyRestaurantsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final res = await _api.get('/restaurants/my');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ModernAppBar(title: 'আমার রেস্টুরেন্ট', subtitle: 'আপনার যুক্ত করা তালিকা'),
        ...
        child: ListView(
          ...
          children: [
            if (_loading)
              ...
              const Padding(
                padding: EdgeInsets.only(top: 30),
                child: Center(child: Text('আপনার কোনো রেস্টুরেন্ট নেই')),
              )
            else
              ..._items.map((restaurant) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    onTap: () => Navigator.of(context).push(
                      MaterialPageRoute(builder: (_) => RestaurantFormScreen(initial: restaurant)),
                    ),
                  ),
                );
              }),
