...
class CourierOfficeDetailsScreen extends StatefulWidget {
  const CourierOfficeDetailsScreen({super.key, required this.officeId});
...
class _CourierOfficeDetailsScreenState
  ...
  Future<void> _load() async {
    ...
    try {
      final res = await _api.get('/couriers/offices/${widget.officeId}');
  ...
  Future<void> _loadReviews() async {
    try {
      final res = await _api.get('/reviews/courier/${widget.officeId}');
  ...
  Widget _info(ColorScheme scheme) {
    ...
    final services = (_office?['services'] as List?)?.cast<String>() ?? [];
