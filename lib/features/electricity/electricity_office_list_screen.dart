...
class ElectricityOfficeListScreen extends StatefulWidget {
  ...
  @override
  State<ElectricityOfficeListScreen> createState() =>
      _ElectricityOfficeListScreenState();
}

class _ElectricityOfficeListScreenState
    extends State<ElectricityOfficeListScreen> {
    ...
    try {
      final res = await _api.get(
        ...
        query: {
          ...
          if (_provider.text.trim().isNotEmpty)
            'provider': _provider.text.trim(),
          if (_officeType.text.trim().isNotEmpty)
            'office_type': _officeType.text.trim(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ModernAppBar(
        title: 'বিদ্যুৎ অফিস',
        subtitle: 'বিদ্যুৎ অফিসের তালিকা',
      ),
              ...
              children: [
                Expanded(
                  child: FilledButton.icon(
                    onPressed: () => Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const ElectricityOfficeFormScreen(),
                      ),
                    ),
                ...
                Expanded(
                  child: FilledButton.icon(
                    onPressed: () => Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const MyElectricityOfficesScreen(),
                      ),
                    ),
    ...
    return InkWell(
      ...
      onTap: id > 0
          ? () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => ElectricityOfficeDetailsScreen(officeId: id),
              ),
            )
          : null,
      child: Container(
