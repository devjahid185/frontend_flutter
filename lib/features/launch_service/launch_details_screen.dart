...
class _LaunchDetailsScreenState extends State<LaunchDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ModernAppBar(
        title: 'লঞ্চ বিস্তারিত',
        subtitle: 'রুট, সময় ও যোগাযোগ',
      ),
      body: _loading
          ...
          : ListView(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${_s('route_from', 'রুট নেই')} → ${_s('route_to', 'রুট নেই')}',
                          style: TextStyle(
                            fontSize: 16,
                        ...
                        Text(
                          _s('operator_name', 'অপারেটর তথ্য নেই'),
                ...
                _section('যোগাযোগ', [
                  ...
                  _row(
                    'ফোন',
                    ((_item?['phones'] as List?)?.join(', ') ?? 'দেওয়া নেই'),
                  ),
                  ...
                  children: [
                    Expanded(
                      child: FilledButton.icon(
                        onPressed: () => _open(_s('hotline', ''), 'tel'),
  ...
  String _money(String key) =>
      _s(key, '').isEmpty ? 'দেওয়া নেই' : '৳ ${_s(key)}';
  String _yesNo(String key) =>
      _item?[key] == true || _item?[key] == 1 ? 'আছে' : 'নেই';
}
