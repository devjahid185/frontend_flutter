...
class TeacherRequestDetailsScreen extends StatefulWidget {
  ...
  @override
  State<TeacherRequestDetailsScreen> createState() => _TeacherRequestDetailsScreenState();
}

class _TeacherRequestDetailsScreenState extends State<TeacherRequestDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ModernAppBar(title: 'টিউশন রিকোয়েস্ট', subtitle: 'বিস্তারিত'),
      body: _loading
