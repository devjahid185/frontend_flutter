...
class TeacherRequestListScreen extends StatefulWidget {
  ...
  @override
  State<TeacherRequestListScreen> createState() =>
      _TeacherRequestListScreenState();
}
          ...
          children: [
            FilledButton.icon(
              onPressed: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => const TeacherRequestFormScreen(),
                ),
              ),
    ...
    return InkWell(
      onTap: id > 0
          ? () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => TeacherRequestDetailsScreen(requestId: id),
              ),
            )
          : null,
