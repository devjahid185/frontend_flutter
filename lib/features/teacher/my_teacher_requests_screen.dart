...
class MyTeacherRequestsScreen extends StatefulWidget {
  ...
  @override
  State<MyTeacherRequestsScreen> createState() => _MyTeacherRequestsScreenState();
}
...
class _MyTeacherRequestsScreenState extends State<MyTeacherRequestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ModernAppBar(title: 'আমার টিউশন রিকোয়েস্ট', subtitle: 'আপনার দেওয়া অনুরোধ'),
