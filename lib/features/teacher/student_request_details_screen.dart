...
class StudentRequestDetailsScreen extends StatefulWidget {
  const StudentRequestDetailsScreen({super.key, required this.requestId});
...
class _StudentRequestDetailsScreenState extends State<StudentRequestDetailsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final res = await _api.get('/student-requests/${widget.requestId}');
