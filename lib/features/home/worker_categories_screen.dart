...
class _WorkerCategoriesScreenState extends State<WorkerCategoriesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    IconData? mapCategoryIcon(String name) {
      ...
      if (n.contains('ইলেক') || n.contains('electric')) return Icons.electrical_services_rounded;
      if (n.contains('প্লাম্ব') || n.contains('পানি') || n.contains('sanitary')) return Icons.plumbing_rounded;
      if (n.contains('রাজ') || n.contains('mason') || n.contains('ইট')) return Icons.foundation_rounded;
      if (n.contains('ছুত') || n.contains('carpenter') || n.contains('ফার্নিচার')) return Icons.carpenter_rounded;
      if (n.contains('রং') || n.contains('paint')) return Icons.format_paint_rounded;
      ...
      if (n.contains('গাড়ি') || n.contains('বাইক') || n.contains('মেকানিক')) return Icons.build_circle_outlined;
      if (n.contains('ড্রাইভার')) return Icons.local_taxi_rounded;
      if (n.contains('টিউট')) return Icons.school_rounded;
      if (n.contains('রাঁধ') || n.contains('কুক')) return Icons.restaurant_rounded;
      if (n.contains('ক্লিন') || n.contains('পরিচার')) return Icons.cleaning_services_rounded;
      if (n.contains('ডেলিভারি')) return Icons.delivery_dining_rounded;
      if (n.contains('ওয়েল্ড')) return Icons.hardware_rounded;
      if (n.contains('সিসিটিভি') || n.contains('নেটওয়ার্ক')) return Icons.settings_input_antenna_rounded;
      if (n.contains('গ্লাস') || n.contains('অ্যালুমিন')) return Icons.window_rounded;
    ...
    return Scaffold(
      appBar: const ModernAppBar(title: 'কর্মী ক্যাটাগরি', subtitle: 'সব ধরনের মিস্ত্রি'),
      body: _loading
                          ...
                          leading: CircleAvatar(
                            ...
                            child: iconUrl != null
                                ...
                                : (mappedIcon != null
                                    ...
                                    : Text(
                                        name.isNotEmpty ? name.substring(0, 1) : 'ক',
                                        style: TextStyle(color: scheme.primary, fontWeight: FontWeight.w700),
                                      )),
                          ),
                          title: Text(name, style: TextStyle(color: scheme.onSurface, fontWeight: FontWeight.w700)),
                          subtitle: Text('মোট কর্মী: $count', style: TextStyle(color: scheme.onSurfaceVariant)),
                                ...
                                builder: (_) => ApiListScreen(
                                  ...
                                  floatingActionButton: FloatingActionButton.extended(
                                    onPressed: () {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (_) => WorkerAddScreen(initialCategoryId: id),
                                        ),
                                      );
                                    },
