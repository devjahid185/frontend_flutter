...
const homeServiceModules = <ReadModule>[
  ...
  ReadModule(
    ...
    subtitle: 'লোকাল দোকান ও সেবা',
    endpoint: '/businesses',
    icon: Icons.business,
    section: 'মার্কেট',
    layout: ModuleLayout.business,
  ),
  ReadModule(
    title: 'মার্কেটপ্লেস',
    subtitle: 'বাই-সেল পণ্য',
    endpoint: '/items',
    icon: Icons.storefront,
    section: 'মার্কেট',
    layout: ModuleLayout.marketplace,
  ),
  ReadModule(
    title: 'চাকরি',
    subtitle: 'লোকাল জব পোস্ট',
    endpoint: '/jobs',
    icon: Icons.work,
    section: 'ক্যারিয়ার',
    layout: ModuleLayout.jobs,
  ),
  ReadModule(
    title: 'প্রোপার্টি',
    subtitle: 'ভাড়া ও বিক্রয়',
    endpoint: '/properties',
    icon: Icons.home_work,
    section: 'মার্কেট',
    layout: ModuleLayout.property,
  ),
  ReadModule(
    title: 'রক্তদাতা',
  ...
  ReadModule(
    title: 'হোটেল',
    subtitle: 'হোটেল ও গেস্ট হাউস',
    endpoint: '/hotels',
    icon: Icons.hotel,
    section: 'সেবা',
    layout: ModuleLayout.hotel,
  ),
  ReadModule(
    title: 'রেস্টুরেন্ট',
    subtitle: 'খাবার ও রেস্টুরেন্ট',
  ...
  ReadModule(
    title: 'গাড়ি ভাড়া',
    subtitle: 'যাত্রী/পণ্য পরিবহন',
    endpoint: '/car-rentals',
    icon: Icons.directions_car,
    section: 'মার্কেট',
    layout: ModuleLayout.carRental,
  ),
  ReadModule(
    title: 'লঞ্চ সার্ভিস',
    subtitle: 'সময়, রুট, ভাড়া ও হটলাইন',
    endpoint: '/launches',
  ...
  ReadModule(
    title: 'কুরিয়ার',
    subtitle: 'কুরিয়ার সার্ভিস তালিকা',
    endpoint: '/couriers/companies',
  ...
  ReadModule(
    ...
    icon: Icons.campaign,
    section: 'কমিউনিটি',
    layout: ModuleLayout.notices,
  ),
  ReadModule(
    title: 'কর্মী ক্যাটাগরি',
    subtitle: 'পেশাভিত্তিক তালিকা',
    endpoint: '/worker/categories',
    icon: Icons.category,
    section: 'সেবা',
...
const marketplaceModules = <ReadModule>[
  ...
  ReadModule(
    title: 'প্রোপার্টি',
    subtitle: 'ভাড়া/বিক্রয় সম্পত্তি',
    endpoint: '/properties',
    icon: Icons.home_work,
    section: 'মার্কেট',
    layout: ModuleLayout.property,
...
const quickActions = <ActionModule>[
  ...
  ActionModule(
    title: 'কাজ খুঁজছি',
    subtitle: 'নিজের অভিজ্ঞতা দিয়ে চাকরির পোস্ট দিন',
  ...
  ActionModule(
    ...
    subtitle: 'চেম্বার, ফি ও সময়সূচি যোগ করুন',
  ...
  ActionModule(
    title: 'লঞ্চ তথ্য যোগ',
    subtitle: 'রুট, ছাড়ার সময়, ভাড়া ও হটলাইন যোগ করুন',
  ...
  ActionModule(
    title: 'কুরিয়ার যোগ',
    subtitle: 'কুরিয়ার অফিস ও ডেলিভারি তথ্য যোগ করুন',
